...
export function SeatMarker({
  ...
  const tokenStateClass = [
    ...
    plannerHighlighted ? "border-[#6E655A] bg-[#EFE9DF] text-[#353532] ring-2 ring-[#D8D0C5] shadow-[0_6px_14px_rgba(110,101,90,0.23),inset_0_1px_0_rgba(255,255,255,0.72)]" : "",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {draftChanged && !selected && !searchProminent && (
          <span className="pointer-events-none absolute -right-1 -top-1 grid h-3.5 w-3.5 place-items-center rounded-full border border-white/85 bg-[#A26E23] text-[8px] font-black leading-none text-white shadow-[0_2px_5px_rgba(23,26,29,0.24)]" aria-hidden="true">
            D
          </span>
        )}
        {tokenMode === "code" ? (
