...
export function AiHighlightChip({
  ...
  return (
    <div
      ...
      aria-live="polite"
      className="pointer-events-auto flex items-center gap-2 border border-[var(--admin-ai-border)] bg-white bg-[image:var(--admin-ai-aura)] bg-no-repeat px-2.5 py-1.5 text-[12px] font-semibold text-[var(--admin-ai-text)] shadow-[0_6px_16px_rgba(69,137,255,0.20)]"
    >
