...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={
        className ??
        "flex h-7 items-center gap-1.5 border border-[var(--sp-border-strong)] bg-transparent px-2.5 text-[11.5px] font-medium text-[var(--sp-text-secondary)] transition-colors hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--admin-primary)]"
      }
    >
      {dark ? (
