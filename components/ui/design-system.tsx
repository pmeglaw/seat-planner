...
export const markerStateClassRecipes = {
  ...
  validDestination: "border-[#3F6F59] bg-[#DDE9DF] text-[#284C3B] ring-4 ring-[#BFD4C4]",
  invalidDestination: "border-[#963D2F] bg-[#F3DAD2] text-[#7E2F24] ring-4 ring-[#D9A296]",
  swapSource: "border-[#3E6F72] bg-[#DCEDEA] text-[#244E50] ring-4 ring-[#A9CFCC]",
  swapTarget: "border-[#6E655A] bg-[#F1ECE4] text-[#353532] ring-4 ring-[#D8D0C5]",
  protectedOriginal: "border-[#696159] bg-[#E7E1D8] text-[#353532]",
  customSeat: "border-[#C2410C] bg-[#F6E7D8] text-[#6F2C13]",
  reserved: "border-[#9A6418] bg-[#F1E2C4] text-[#6D4712]",
