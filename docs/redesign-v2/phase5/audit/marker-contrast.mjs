...
//
// Phase 5 PR 3 copy of phase4/audit/marker-contrast.mjs (Phase 4 is closed record, untouched): the names-off
// branch measures the footprint carrying ● — its edge on the mat here, the ● on the fill through the generic
// mark branch — and the viewer pass adds names-off-quiet, the admin pass names-off-draft.
// Usage: node docs/redesign-v2/phase5/audit/marker-contrast.mjs <baseUrl> <outDir> <adminEmail> <adminPassword>
