...
const P = { // palette, as carbon-tokens.css
  ...
  r40: "#ff8389", o40: "#ff832b", o60: "#ba4e00", r50: "#fa4d56", r60: "#da1e28", gr40: "#42be65", gr60: "#198038", gr10: "#defbe6", y30: "#f1c21b", y60: "#8e6a00", p40: "#be95ff", p60: "#8a3ffc",
};
...
const L = { bg: ["white", P.white], l1: ["layer-01 #f4f4f4", P.g10], hover: ["layer-hover-01 #e8e8e8", P.hoverWhite], sel: ["layer-selected #e0e0e0", P.g20], hi: ["hit fill #fbe8dc (O2, brand tint; was highlight #d0e2ff)", BRAND.tint], ok: ["success-subtle #defbe6", P.gr10], err: ["error-subtle #fff1f1", "#fff1f1"] };
...
// O3 (PR 3b): the Draft family is purple 60 light / purple 40 dark (DECISIONS §6 no. 17) — the ◇ badge, the
...
// PR 3b marker rig: the names-off footprint states — quiet fill on the mat (was the quiet edge gray-30, 1.71), the ◇ on the filled square (was purple 60, 3.62 / purple 40, 2.14 on dark).
add(gated, "light · names-off quiet footprint gray-70 on the mat (background white)", P.g70, P.white, "graphic");
add(gated, "light · names-off ◇ stroke = pill fill white on the gray-100 footprint", P.white, P.g100, "graphic");
...
// ---- Dark theme surfaces ----------------------------------------------------------
const D = { bg: ["background #161616", P.g100], l1: ["layer-01 #262626", P.g90], hover: ["layer-hover-01 #333333", P.hoverG90], sel: ["layer-selected #393939", P.g80], fill2: ["layer-02 / pill fill #393939", P.g80], hover2: ["layer-hover-02 #474747", P.hoverG80], hi: ["hit fill = layer-02 #393939 (O2: neutral fill on dark, the edge carries the hue; was highlight #001d6c)", P.g80] };
...
add(gated, "dark · names-off quiet footprint gray-30 on the mat (background #161616)", P.g30, P.g100, "graphic");
add(gated, "dark · names-off ◇ stroke = pill fill #393939 on the gray-10 footprint", P.g80, P.g10, "graphic");
