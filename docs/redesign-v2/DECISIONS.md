...
question recorded in PHASE5 PR 4 "Carried". **Ruled 2026-09-10 (O5, Phase 5 PR 5):** the role itself is #E8A07A on
dark; R5's own override retires into it — §6 no. 16.
...
*Phase 5 PR 5 (v2.5.0, 2026-09-10) is brand ruling O5, recorded inside no. 16: the interactive-border role's dark
value moves within the brand's own scale (#B85C2E → #E8A07A, the dark link colour); no new deviation, next free stays 19.*
