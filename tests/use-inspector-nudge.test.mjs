...
// Geometry shared by every test: a 1200px viewport/frame with NO scroll room
// (scrollWidth === clientWidth), so a needed nudge is forced entirely onto
// the translate channel — the only channel this hook owns.
const VIEWPORT_WIDTH = 1200;

function stubGeometry(viewportEl, frameEl) {
  Object.defineProperty(frameEl, "offsetLeft", { value: 0, configurable: true });
  Object.defineProperty(frameEl, "offsetWidth", { value: VIEWPORT_WIDTH, configurable: true });
  Object.defineProperty(viewportEl, "clientWidth", { value: VIEWPORT_WIDTH, configurable: true });
  Object.defineProperty(viewportEl, "scrollWidth", { value: VIEWPORT_WIDTH, configurable: true });
...
function Host({ selectedSeatId, inspectorHidden = false, panelBreakpointPx = 0, animate }) {
...
async function renderHost(props) {
  ...
  stubGeometry(viewportEl, frameEl);
