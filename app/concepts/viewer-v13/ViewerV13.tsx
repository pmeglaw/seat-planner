...
const GLASS: RunoffTheme = {
  ...
  chipClass:
    "rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/70 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[#FF7A1F]",
  chipActiveClass:
    "rounded-full border border-[#FF7A1F]/70 bg-[#FF7A1F]/15 px-3 py-1.5 text-xs font-medium text-[#ffb694] outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[#FF7A1F]",
  fieldLabelClass: "text-[11px] font-medium uppercase tracking-[0.18em] text-white/50",
  fieldClass:
    "w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder:text-white/30 outline-none focus-visible:ring-2 focus-visible:ring-[#FF7A1F]",
  toggleGroupClass: "flex items-center gap-1 rounded-full border border-white/15 p-1",
  toggleClass:
    "rounded-full px-4 py-1.5 text-xs font-medium text-white/60 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[#FF7A1F]",
  toggleActiveClass:
    "rounded-full bg-white px-4 py-1.5 text-xs font-semibold text-black outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[#FF7A1F]"
};
