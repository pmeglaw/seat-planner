...
export default async function ReceptionPage() {
  ...
  return (
    ...
    <main className="reception-theme flex h-[calc(100svh-var(--admin-chrome-h))] flex-col overflow-hidden bg-[var(--r-bg)] pl-12 text-[var(--r-text)]">
      ...
      <div
        ...
        tabIndex={0}
        className="min-h-0 flex-1 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--r-accent)]"
      >
